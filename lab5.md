...
2. В чем суть обобщенных функций? Как это влияет на написание алгоритмов?
3. В чем отличие шаблонов от абстрактных классов для объявления интерфейсов? 
4. С какой целью определяют шаблонные параметры для класса? 