...
2. С какой целью определяют шаблонные параметры для класса?
3. В чем суть обобщенных функций? Как это влияет на написание алгоритмов?
4. В чем отличие шаблонов от абстрактных классов для объявления интерфейсов?
5. Какая разница между динамическим и статическим полиморфизмом? 
