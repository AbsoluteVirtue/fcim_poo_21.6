...
3. Какие 3 конструктора являются особенными и генерируются компилятором во всех классах по-умолчанию?
4. Что такое деструктор? С какой целью его объявляют в классе?
5. Как деструктор используется в программе?
6. В чем принципиальная разница между копированием и перемещением? В каких случаях вызывается конструктор перемещения?