...
Простой пример это иллюстрирует. Предположив, что есть набор функций:
1. *transform*, которая в качестве аргументов принимает какой-то текст и функцию для обработки переданного текста, и возвращает обработанный текст;
2. *to_lower*, которая принимает произвольную строку и возвращает строку;
3. *replace*, которая принимает строку и целевой символ, и возвращает строку;
4. *sort*, которая принимает текст и возвращает текст;
5. *remove_duplicate*, которая принимает текст и возвращает текст;
6. *count*, которая принимает текст и строку и возвращает целое число;

-- эти функции можно комбинировать, чтобы получить полноценное приложение. 
