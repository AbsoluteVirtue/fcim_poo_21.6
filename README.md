...
*Событие -- это
**Замкнутость -- это
***Делит это звание с Simula 67, так как основные механизмы, ассоциирующиеся с ООП появились сначала в Simula, но термин "объектно-ориентированный" появился для описания Smalltalk.
****https://github.com/gnu-smalltalk/smalltalk/blob/master/kernel/True.st
*****https://computinged.wordpress.com/2010/09/15/alan-kay-on-motis-objects-ever-cacm-article/
******https://www.tiobe.com/tiobe-index/
*******имеется ввиду расширение засчет композиции, одновременно с этим -- создание подтипов и как следствие -- полиморфизм

OOPSLA 1997, Презентация А. Кея, https://www.youtube.com/watch?v=oKg1hTOQXoY
"Монады за 15 минут", https://habr.com/ru/post/445800/
