...
В контекте программ, которые состоят из большого количества компонентов, для управления их сложностью используются общепринятые техники.
1. "Черный ящик".
2. Интерфейс.
3. Мета-лингвистика.

"Черный ящик" -- это пример абстракции, с которой многие знакомятся рано благодаря тому, что функции часто ассоциируют с этой идеей. 
...
Единственной операцией здесь, которая ассоциируется непосредственно с массивами, является инициализация массива как сплошного блока памяти из 10 значений типа int. Таким образом массивы в С – это ссылки на уже существующие участки памяти, которые ассоциируются с конкретным именем при объявлении массива в программе.
