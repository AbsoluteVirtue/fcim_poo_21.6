...
2. Какой вид итератора требуется определить для вашего варианта? Почему?
3. Какие операции должен поддерживать итератор такого вида?
4. С какой целью определяют методы begin и end для своего класса?
5. Как определяется reverse_iterator?