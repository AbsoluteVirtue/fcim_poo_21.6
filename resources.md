# Что можно посмотреть и почитать на каникулах для подготовки ко второму курсу 
...
3. Вводный курс по написанию собственного языка программирования -- R. Nystrom, Crafting Interpreters (англ.)
https://craftinginterpreters.com/contents.html
4. Структура и интерпретация компьютерных программ (JavaScript, англ.) -- G.J. Sussman, SICP
