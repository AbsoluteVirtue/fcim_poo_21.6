...
### Контрольные вопросы
1. С какой целью определяют итераторы для класса?
2. Как итераторы позволяют использовать стандартные функции из библиотеки алгоритмов?
3. Как и для чего используются анонимные функции в комбинации со стандартными алгоритмами?
## Итераторы
...
```
### Контрольные вопросы
1. Какой вид итератора требуется определить для вашего варианта? Почему?
2. Какие операции должен поддерживать итератор такого вида?
3. С какой целью определяют методы begin и end для своего класса?
4. Как определяется reverse_iterator?