...
### Контрольные вопросы
1. Что такое конструктор? С какой целью их объявляют в классе?
2. Как конструкторы используются в программе?
3. Что такое деструктор? С какой целью его объявляют в классе?
4. Как деструктор используется в программе?
...
```
### Контрольные вопросы
1. Какие 3 конструктора являются особенными и генерируются компилятором во всех классах по-умолчанию?
2. В чем принципиальная разница между копированием и перемещением? В каких случаях вызывается конструктор перемещения?
3. В чем разница между объектами l-value и r-value ссылочных типов, а также константными ссылками?
4. В чем особенность сравнения двух объектов заданного типа? Какие данные типа сравниваются, а какие игнорируются? Почему?
5. В чем особенность определения функции swap для пользовательского класса?